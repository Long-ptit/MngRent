...
class DetailStaffActivity :
    BaseActivity<ManageStaffViewModel, LayoutDetailStaffBinding>(){


    override fun getContentLayout(): Int {
        return R.layout.layout_detail_staff
    }
    ...
    override fun observerLiveData() {
        viewModel.apply {
            saveStaffResponse.observe(this@DetailStaffActivity) {
                if (it != null) {
                    finish()
                }
        ...
        viewModel.apply {
            deleteResponse.observe(this@DetailStaffActivity) {
                if (it != null) {
                    finish()
                }
    ...
    override fun initView() {
        showError = true
        mStaff = intent.getSerializableExtra("staff") as Staff
