...
import restaurant.exam.databinding.LayoutMainStaffBinding


class MainActivityStaff : BaseActivity<MainViewModel, LayoutMainStaffBinding>(), BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    companion object {
        fun getIntent(
            ...
            return Intent(context, MainActivityStaff::class.java)
        }
    }
    override fun getContentLayout(): Int {
        return R.layout.layout_main_staff
    }
